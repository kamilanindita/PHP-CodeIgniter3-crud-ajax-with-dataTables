...
<body>
    ...
    <div class="container">
        <h1 style="font-size:20pt">CodeIgniter 3 Ajax CRUD with DataTable</h1>
...
function edit_buku(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('buku/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('buku/ajax_add')?>";
    } else {
        url = "<?php echo site_url('buku/ajax_update')?>";
    }
...
function delete_buku(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('buku/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Buku Form</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="penerbit" placeholder="Penerbit" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
